...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), '/docs/bsa.html')) })
---
...
## Add missing values based on manual lookup of BSA decision database.
