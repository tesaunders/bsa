...
Download and read in two datasets: the first is for complaints made under the previous BSA Codebook (1 April 2016 to 30 June 2022); the second is for complaints made under the current Codebook (1 July 2022 to present).

```{r}
download.file("https://auckland.figshare.com/ndownloader/articles/24037866/versions/1",
              "data/AllClosedFormalComplaints.zip", mode = "wb")

unzip(zipfile = "data/AllClosedFormalComplaints.zip", exdir = "data/", overwrite = TRUE)
...
```{r}
#| label: complaints-by-viewership
...
```{r}
#| label: complaints-by-broadcaster
